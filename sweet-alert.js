...
(function(window, document) {
  ...
  function initialize() {
    var sweetHTML = '<div class="sweet-overlay" tabIndex="-1"></div><div class="sweet-alert" tabIndex="-1"><div class="icon error"><span class="x-mark"><span class="line left"></span><span class="line right"></span></span></div><div class="icon warning"> <span class="body"></span> <span class="dot"></span> </div> <div class="icon info"></div> <div class="icon success"> <span class="line tip"></span> <span class="line long"></span> <div class="placeholder"></div> <div class="fix"></div> </div> <div class="icon custom"></div> <h2>Title</h2><p>Text</p><button class="cancel" tabIndex="2">Cancel</button><button id="disableMe" class="confirm" tabIndex="1">OK</button></div>',
      ...
      if (keyCode === 9) {
        ...
        if (keyCode === 13 || keyCode === 32) {
            if (btnIndex === -1) {
              ...
              //setTimeout(function(){clearTimeout(funcSetTimeout)}, 500)
            } else {
              // Do nothing - let the browser handle it.
              $targetElement = undefined;
              //document.getElementById("disableMe").disabled = true;
              //setTimeout(function(){console.log("disabled every 400 + 2 "); document.getElementById("disableMe").disabled = false;}, 400)
            }
